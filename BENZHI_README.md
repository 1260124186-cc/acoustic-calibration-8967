# acoustic-calibration__005 Docker 交付说明
...
```bash
./build_benzhi_docker.sh acoustic-calibration__005-benzhi linux/amd64
docker run --rm -it acoustic-calibration__005-benzhi bash
```
